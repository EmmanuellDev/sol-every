        ...
        <div className='container'>
          ...
          <div className='grid gap-10 lg:grid-cols-2'>
            <div className='ps-4 hidden py-4 pt-10 lg:block'>
              ...
              <textarea rows='6' onChange={(e) => handleFormFieldChange("description", e)} className='border-default-200 relative mt-48 block w-full rounded border-white/10 bg-transparent py-1.5 px-3 text-white/80 focus:border-white/25 focus:ring-transparent' placeholder='description of your token'>
              </textarea>
            </div>
              ...
              <div className='pb-6 my-auto'>
                ...
                <div className='text-start'>
                  ...
                  <div className='mb-6 text-center'>
                    <button onClick={() => createToken(token)} className='bg-primary-600/90 hover:bg-primary-600 group mt-5 inline-flex w-full items-center justify-center rounded-lg px-6 py-2 text-white backdrop-blur-2xl transition-all duration-500' type='sumbit'>
