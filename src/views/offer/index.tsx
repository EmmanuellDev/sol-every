        ...
        <div className='mb-10 flex items-end justify-between'>
          <div className='mx-auto max-w-2xl text-center'>
            ...
            <p className='text-default-200 text-sm font-medium'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis odit minus earum. Tempore natus facilis soluta eius sapiente dicta voluptatibus quam enim laboriosam, hic ipsum, minus tenetur, quisquam quos nemo!
            </p>
          </div>
        </div>
        <div className='grid gap-6 lg:grid-cols-3'>
          <div className='space-y-6'>
            ...
            <div className='p-10'>
              ...
              <p className='text-default-100 mb-4 text-sm font-medium'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus animi hic repellendus obcaecati.</p>
