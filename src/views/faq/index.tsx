      ...
      <div className="container">
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-default-200 text-sm font-medium">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis quae unde magni aliquid eos quod amet eaque modi.</p>
          </div>
        </div>
              ...
              <div key={index} className={`hs-accordion bg-default-950/40 overflow-hidden rounded-lg border border-white/10 backdrop-blur-3xl`} id={question.id}>
                ...
                <div id={`faq-accordion-${index + 1}`} className="hs-accordion-content w-full overflow-hidden transition-[height] duration-300" aria-labelledby={question.id}>
                  <div className="px-6 pb-4 pt-0">
                    <p className="text-default-300 mb-2 text-sm font-medium">{question.answer}</p>
                    <p className="text-default-300 text-sm font-medium">Have you ever wanted to become blockchain developer check the pro NFT Marketplace Course</p>
                  </div>
                </div>
              </div>
            ))}
